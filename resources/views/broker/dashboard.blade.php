                    ...
                    <div class="table-responsive mb-0">
                        <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{asset('assets/img/faces/7.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{asset('assets/img/faces/6.png')}}"><img class="profile-img brround" alt="profile image" src="{{asset('assets/img/faces/16.jpg')}}"></div>
                                </td>
                                <td>Android</td>
                                <td>15 March 2020</td>
                                <td><span class="badge bg-success-gradient">Ongoing</span></td>
                ...
                <div class="card-body p-0">
                    <div class="activity Activity-scroll">
                        <div class="activity-list">
                            <img src="{{asset('assets/img/faces/6.png')}}" alt="" class="img-activity">
                            ...
                            <img src="{{asset('assets/img/faces/9.jpg')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="{{asset('assets/img/faces/3.jpg')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="{{asset('assets/img/faces/4.jpg')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity ">
                            ...
                            </div> <img src="{{asset('assets/img/faces/5.jpg')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="{{asset('assets/img/faces/6.png')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="{{asset('assets/img/faces/16.jpg')}}" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                                    <p class="mb-0"><span class="h6 me-1">John Payne</span><span class="text-muted tx-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small> </div>
                            </div> <img src="{{asset('assets/img/faces/10.jpg')}}" alt="" class="img-activity">
